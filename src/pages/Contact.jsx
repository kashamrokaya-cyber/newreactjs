  ...
  return (
    <div className=' bg-green-400 px-4 flex justify-center items-center'>
      <div className='w-full bg-white max-w-xl p-8'>
        ...
        <form className=' inline w-100  bg-amber-50 text-center mt-4  ' action="">
               <input className='pr-8 py-2 w-1/2 block mt-4 outline-none border-2' type="text" placeholder='Full name' />
               <input className='pr-18 py-2 w-1/2 block mt-4 border-2  outline-none' type="text" placeholder='Email Address' />
               <input className='pr-18 py-2 w-1/2  block mt-4 border-2 outline-none ' type="text" placeholder='Phone number' />
               <input className='pr-18 py-2 w-1/2 block  mt-4 border-2 outline-none' type="text" placeholder='Address' />
               <textarea className='text-black block mt-4 border-2 outline-none' name="text" id="" placeholder='Write your comment'></textarea>
        </form>
        </div> */}
